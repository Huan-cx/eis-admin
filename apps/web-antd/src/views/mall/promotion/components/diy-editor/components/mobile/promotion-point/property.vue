...
<template>
  <ComponentContainerProperty v-model="formData.style">
    ...
    >
      <Card
        :title="$t('promotion.point.activity.title')"
      ...
      <Card :title="$t('promotion.diy.editor.style.badge')" class="property-group">
      ...
      <Card :title="$t('promotion.diy.editor.style.button')" class="property-group">
        <FormItem :label="$t('promotion.diy.editor.style.buttonType')" name="btnBuy.type">
          <RadioGroup v-model:value="formData.btnBuy.type">
            <RadioButton value="text">{{ $t('promotion.diy.editor.style.text') }}</RadioButton>
            <RadioButton value="img">{{ $t('promotion.diy.editor.style.image') }}</RadioButton>
          </RadioGroup>
        </FormItem>
      ...
      <Card :title="$t('promotion.diy.editor.style.productStyle')" class="property-group">
